...
export default function Home() {
  return (
    <>
      <Helmet>
        <title>StatutIQ - Trouvez le meilleur statut juridique freelance</title>

        <meta
          name="description"
          content="Comparez EURL, SASU, micro-entreprise, portage salarial et obtenez une recommandation personnalisée grâce à l'IA."
        />
      </Helmet>
